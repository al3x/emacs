...
;; Changes from 1.3a to 1.3.1
;; * Fixed versioning so that it works with package.el
;; * Changed URL as Colin's website appears to be down
...
;; * Patch from Michal Marauka <mmc@maruska.dyndns.org> which handles
